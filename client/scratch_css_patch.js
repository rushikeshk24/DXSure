...
filesToPatch.forEach(file => {
  ...
  if (fs.existsSync(fullPath)) {
    ...
    content = content.replace(/border border-white\/10 bg-neutral-900\/50/g, "bg-[#ffffff] shadow-[0_4px_24px_rgba(24,28,30,0.04)]");
    ...
    content = content.replace(/hover:border-emerald-500\/20/g, "hover:bg-[#ebeef0] hover:shadow-[0_8px_32px_rgba(24,28,30,0.06)] border border-transparent");
    ...
    content = content.replace(/border border-white\/10 bg-neutral-900\/50 px-3.5 py-2.5 text-white focus:border-emerald-500 focus:ring-emerald-500\/20/g, 
            "border border-[#c4c6cf]/20 bg-[#ffffff] px-3.5 py-2.5 text-[#181c1e] focus:border-[#0061a5] focus:outline-none focus:ring-2 focus:ring-[#0061a5]/10 shadow-[0_2px_12px_rgba(24,28,30,0.02)]");
